...
export default function ClimaScreen({ theme, darkMode, onToggleTheme }: Props) {
        ...
        <View style={styles.switchContainer}>
          ...
          <Pressable
            ...
            style={[
              styles.customSwitch,
              {
                backgroundColor: darkMode ? theme.accent : "#cbd5e1",
                justifyContent: darkMode ? "flex-end" : "flex-start",
              },
            ]}
          >
            <View style={styles.switchThumb}>
              <Text style={styles.switchEmoji}>{darkMode ? "🌙" : "🌞"}</Text>
            </View>
          </Pressable>
        </View>
      </View>
